  ...
  return (
    <>  
        <motion.div className='login-page' exit={{opacity:0}}>
            ...
            <p>Currently SignUp, Chat Features are partially implemented ...</p>
            ...
            <section className='todos'>
                ...
                <ul>
                   <a href="https://github.com/venkatthirupathi/Real-Time-Code-Editor/issues/1"><li>Enable Simultaneous Coding </li></a>
                    <a href=""><li>Efficient Database Implementation for Storing Individual Team's Code <span className='highlite'></span> </li></a>
                   <a href="https://github.com/venkatthirupathi/Real-Time-Code-Editor/issues/2"><li>Enhanced Code Editor: Customizable Theme Selection and UI</li></a> 
                   <a href="https://github.com/venkatthirupathi/Real-Time-Code-Editor/issues/3"><li>Advanced Speech Recognition Module: Hands-free Coding Experience</li></a> 
                   <a href="https://github.com/venkatthirupathi/Real-Time-Code-Editor/issues/4">
                    <li>Implement Encreption and Decreption Algorithem At Server and Client Side</li>
                   </a>
                   <a href="https://github.com/venkatthirupathi/Real-Time-Code-Editor/"> <li>Contribute To Project</li></a>
                </ul>
            </section>
            ...
            <footer>
                <ul>
                    ...
                    <a href="https://www.linkedin.com/in/thirupathivenkat/">
                        <img src={linkedin} alt="" className="social-icon"/>
                    </a>
                    <a href="https://hashnode.com/@venkat123">
                ...
                <center className='highlite'><h3>VENKAT THIRUPATHI<br /></h3>thirupathivenkat2005@gmail.com</center>
